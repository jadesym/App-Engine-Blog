...
/*			if (strTo == null) throw new Exception("To field cannot be empty.");
			...
			msg.setFrom(new InternetAddress("anything@shenfuweatherblog.appspotmail.com"));
			
			List<EmailAddress> addresses = ofy().load().type(EmailAddress.class).list();
			for (EmailAddress send: addresses){
				msg.addRecipient(Message.RecipientType.TO,
						new InternetAddress(send.email));
			}
			msg.setSubject("ShenFu Weather Blog Daily Digest");
			...
			String message = "Hello. Here are recent posts made at ShenFu Weather Blog" 
		    + "\r\n" + "\r\n" + "=================================" + "\r\n";
