      ...
      <p style="font-size: 30px;">Hello, ${fn:escapeXml(user.nickname)}! (You can
		<a href="<%= userService.createLogoutURL(request.getRequestURI()) %>">sign out</a>.)</p>
		 <form action="/subscribe" method="get">
          <div><button class="btn btn-warning" style="border-radius: 20px;"><h4 style="padding: 0;">Unsubscribe</h4></button></div>
    </form>
    </div>  
  </div><!-- /.container-fluid -->
</nav>
...
<%
 if (user != null) {
	...
	<br>
	<br>
	<p style="font-size: 20px;">Thank you for subscribing! Daily digests will be sent to your email at 5pm CDT.</p>    
	<br>
	<br>
